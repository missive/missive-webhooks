...
class GitHub extends Integration {
  ...
  issues(payload) {
    ...
    var text, markdown, pretext = this.sanitize(() => `${this.link(issue.html_url, 'Issue')} ${payload.action} by ${this.userLink(sender)}`)
    ...
    return {
      ...
      attachment: { pretext, text, markdown },
    }
  }
  ...
  pull_request(payload) {
    ...
    var text, pretext, markdown, notification
