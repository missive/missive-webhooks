class Integration {
  ...
  get avatar() { return `https://raw.githubusercontent.com/missive/missive-webhooks/master/assets/integrations/${this.id}.png` }
  get icon() { return `https://raw.githubusercontent.com/missive/missive-webhooks/master/assets/integrations/${this.id}.png` }
